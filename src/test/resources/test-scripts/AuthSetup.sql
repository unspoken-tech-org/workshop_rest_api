...
INSERT INTO refresh_tokens (id, token, api_key_id, expires_at, revoked, created_at)
VALUES
    (1, 'rt_EXPIRED_TOKEN_1234567890', 1, CURRENT_TIMESTAMP - INTERVAL '1 hour', false, CURRENT_TIMESTAMP - INTERVAL '1 day');
