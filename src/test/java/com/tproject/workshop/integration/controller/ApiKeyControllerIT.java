...
public class ApiKeyControllerIT extends AbstractIntegrationLiveTest {
    ...
    private static final String AUTH_PATH = "/api/auth/token";
    ...
    @Order(6)
    @DisplayName("Reset API Key device binding")
    @Test
    public void shouldResetDeviceBinding() {
        given().spec(SPEC)
