...
public record TokenRequest(
    @NotBlank(message = "boundDeviceId é obrigatório")
    @Schema(description = "Identificador único do dispositivo vinculado", example = "35245100-ab32-4fd1-9b04-3d59cf56578a", requiredMode = Schema.RequiredMode.REQUIRED)
