...
-- brands_models
alter table brands_models  add constraint fk_brands_models_brand foreign key (id_brand) references brands(id);
alter table brands_models  add constraint fk_brands_models_model foreign key (id_model) references models(id);

-- brands_models_types
alter table brands_models_types add constraint fk_brands_models_types_types foreign key (idType) references types(id);
alter table brands_models_types add constraint fk_brands_models_types_brandModel foreign key (id_brand_model) references brands_models(id);
